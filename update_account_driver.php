...
if ( empty($_REQUEST["did"]) || empty ($_REQUEST["dfullname"]) || empty($_REQUEST["demail"]) || empty($_REQUEST["dmobile"])) {
...
$result = $access->updateAccountDriver($demail, $dmobile, $dfullname, $did);
